自学机器学习，我选择的是吴恩达在Coursera上的公开课**Machine Learning**，学了课程中的两个星期，发现讲得比较明白易懂，连微积分、矩阵都会补充一下基础知识。跟着这门课程，很多东西比较容易地就理解了。这几篇博客，我准备将学习过程中的笔记总结一下。
...
如果一个一个算再相加的话效率相对低下，更好的方法是使用矩阵，假设$x^{(i)}_0 = 1$，那么$h_i(\theta)$也可以使用以下方法计算：
